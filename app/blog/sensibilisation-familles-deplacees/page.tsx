...
import activiteImg from "@/public/activites/sensibilisation-famille-deplacee.jpeg";

const SensibilisationFamillesDeplacees = () => {
  const blogArticle: {
    title: string;
    pubDate: string;
    description: string;
...
export default SensibilisationFamillesDeplacees;
