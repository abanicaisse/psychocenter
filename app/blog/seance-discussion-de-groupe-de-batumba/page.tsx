...
import activiteImg from "@/public/activites/seance-discussion-de-groupe-batumba.jpeg";

const SeanceDiscussionDeGroupeDeBatumba = () => {
  const blogArticle: {
    title: string;
    pubDate: string;
    description: string;
...
export default SeanceDiscussionDeGroupeDeBatumba;
