...
import activiteImg from "@/public/activites/sensibilisation-eleves.jpeg";

const SensibilisationsDesEleves = () => {
  const blogArticle: {
    title: string;
    pubDate: string;
    description: string;
        ...
        <div className={`w-full flex flex-col gap-[1.5rem]`}>
          ...
          <div className="w-full flex-1 flex flex-col gap-6">
            <Image
              ...
              height={100}
              alt={`activité`}
              className="w-full max-h-[750px] rounded-[0.6rem]"
            />
          </div>
...
export default SensibilisationsDesEleves;
